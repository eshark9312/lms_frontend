...
function QuickAccess() {
  return (
    <div className="p-2 border-2 border-dashed rounded-lg flex flex-col justify-center items-center hover:border-primary-600 hover:cursor-pointer hover:bg-primary-100 group click-action">
